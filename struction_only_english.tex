...
\newfontfamily\engfontapprox{FandolFang-Regular.otf}
...
\newcommand{\horizonline}{%
  \begin{center}
    ...
    \raisebox{-2.1pt}{\hspace{1em}\decofourleft\decotwo\decofourright\hspace{1em}}\,   % 然而并不对称 插入 \, 调正
    \rule{0.2\linewidth}{\linethickness}
  \end{center}
}
