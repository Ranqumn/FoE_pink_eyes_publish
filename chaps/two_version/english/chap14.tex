...
\englishdaytimeplace{11}{22:30 P.M.}{Low orbit, $\approx$ 1800\,km above Equestria}
...
{\mten ``\dots Eight\dots seven\dots six\dots''}
...
{\mten ``\dots Five\dots four\dots three\dots''}
...
{\mten ``Attack commenced. Estimated time of arrival for the first salvo: seven minutes.''}
...
{\mten ``Warning. Lost signal from Ponymedes III, V, X, XI and XII. Ponymedes IV and VII report major failures with the recoil compensation system. Ponymedes I, II, VI, VIII and IX are commencing the second barrage in ten\dots nine\dots''}
...
{\mten ``\dots two\dots one\dots Second salvo out. Readying guns for third salvo.''}
...
{\mten ``Repair spell activated. Lost signal from Ponymedes I and II. Ponymedes VI, VII and XI will be ready to fire in ten\dots nine\dots''}
...
{\mten ``Warning. Ponymedes VI is out of ammunition. Signal lost from all the other satellites. Attack aborted. Area will be safe from incoming fire in fifteen minutes. Thank you for choosing Solaris Inc. as your main siege weapon system. Solaris: try the alternative.''}
...
{\mten ``Journal updated. New primary quest: Southern Storm. Broccoli Town Hall set as new primary objective. Broccoli Town Hall marked on the compass.''}
...
{\mten ``Affirmative. Vocal interface is active.''}
