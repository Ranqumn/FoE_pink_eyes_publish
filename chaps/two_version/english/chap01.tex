...
{\mten ``Status of the host: panic.''}

The filly blinked stupidly. What was going on? Who had spoken?

``Wut?''

{\mten ``Internal medical diagnostic initiated. Error! System rebooting. Estimated time: thirty seconds.''}
...
{\mten ``Reboot complete. Checking version. Initiating. Ten seconds to full operational status\dots Eight\dots Seven\dots''}
...
{\mten ``Five\dots Four\dots Three\dots''}
...
{\mten ``Two\dots System rebooted. Starting diagnostic routine. Warning. Primary healing talisman is not responding. Activating backup healing talisman. Starting diagnostic. Female. Foal. Earth pony variety.''}
...
{\mten ``Life support online. Temperature within parameters. Blood pressure within parameters. Warning. Radiation level above the average by three hundred percent.'' }
...
{\mten ``Warning. Minor radiation poisoning detected. Inoculating: Rad-X. Inoculating: RadAway. Inoculating: Rad---}

{\mten ``Warning. Hazardous agent detected. Analyzing. Pink agent, Littlehorn type. Lethal at a concentration exceeding 5\%.''}

{\mten ``1.8\%\dots 2.0\%\dots 2.2\%\dots Warning. Concentration of pink agent above safety limits. Evacuate the area immediately.''}
...
{\mten ``Danger! Mutation detected! Concentration of 5.4\%. Danger! 6.0\%! Evacuate immediately! Contact Ministry of Peace for immediate help! Initiating transmission of distress signal. Scanning for emergency channel. Transmitting. Warning! Concentration at 7.5\%!''}
...
{\mten ``Inoculating: Med-X. Inoculating: Healing potion. Concentration at 12.1\%. Inoculating: Rad-X. Inoculating: RadAway. Concentration of pink agent at 16.0\%. Inoculating: Poison Antidote. Inoculating: Healing potion. Inoculating: Healing potion. Concentration at 22.6\%. Inoculating: Healing potion. Inoculating\dots''}
...
{\mten ``\dots Healing potion. Inoculating: healing potion. Inoculating: healing potion. Warning. Healing potion doses left: three. Concentration of pink agent at 35.0\%. Inoculating\dots''}
...
{\mten ``Bzzzt- FzZZzzZzt- line\dots rebooFZZZt necesszSzT!''}
...
% {\mten ``Fzzzt\dots critical failure\dots no living parFZZZTT! Requesting conffFFZZZTanual rebooting.''}
{\mten ``Fzzzt\dots critical failure\dots no living parFZZZTT! Requesting conffFFZZ-\\ZTanual rebooting.''}
...
{\mten ``Reboot complete. Checking version. File not found. Starting emergency mode. Version 0.2\dots''}
...
{\mten ``New components detected. Initializing matrix. Connecting.''}
...
{\mten ``All systems operational. Starting diagnostic routine. Analyzing. Subject 001, Puppysmiles. Female. Foal. Earth pony variety. No vitals. Checking for errors in diagnostic equipment. No errors found. Repeating diagnostic routine. Female. Foal. Earth pony variety. No vitals.''}

``What are whytles? I want whytles! Are they yummy?'' Puppy exclaimed.

{\mten ``Launching Learning Program for Foals. Connecting to Ministry of Image for recent updates. Unable to establish communication bridge. Launching program from backup files. Please wait for installation to finish.''}
...
{\mten ``Corpse, noun. Remnants of a dead creature--the more you know!''} the suit's metallic voice answered.

``Dead? Like\dots dead dead dead?''

{\mten ``Searching synonyms for dead\dots Cadaverous. Deceased. Defunct. Departed. Done for. Erased. Expired. Extinct. Gone. Inanimate. Inert. Lifeless\dots''}
...
{\mten ``Analyzing: Pony---Unicorn variety. Adult female.''}
...
{\mten ``MoM---Ministry of Morale. Analyzing data. Connecting to Equestrian Cartography Onspark. Downloading data. Error, name matching failed. Searching for MoM broadcasting signal. Spritebot found. Establishing communication bridge\dots ''}
...
{\mten ``Query: broadcasting source. Broadcasting signal found. Location marker transmission in progress\dots''}
...
{\mten ``Ministry of Morale's locations added to map. Nearest MoM hub displayed on the navigator.''}

``Y-you found my mom?'' Puppy exclaimed, feeling a burst of hope.

{\mten ``Affirmative. MoM has been located. Nearest MoM hub outside Canterlot Ruins is set as new navigation priority.''}

``Uh\dots I\dots guess that's a yes?'' The filly tilted her head.

{\mten ``Instructions: follow the pink arrow on the compass until destination is reached.''}
...
{\mten ``Warning. Vital parameters absent. Warning. Medical supplies exhausted. Warning. All emergency channels are mute. Warning\dots''}
...
{\mten ``Negative. Energy supply is sufficient. Estimated lifetime of the spark before red level: one thousand, two hundreds years.''}

``Oh come on! Just sing and stop whining.''

{\mten ``Negative. This is not whining. This is a warning. I can supply appropriate audio samples of whining.''}

``Warning for what? Everything will be all right as soon as we find my mom! She's the coolest pony ever!''

{\mten ``Negative. MoM is not a pony. It is an acronym for---''}

``Of course Mom's a pony\dots and she's not an\dots uh\dots an acrobat either!''

{\mten ``Negative. MoM is Ministry of Morale.''}
...
{\mten ``Warning. Hostile detected. Distance: twenty meters. Analyzing\dots''}
...
{\mten ``Warning. Hostile at six meters and closing.''}
...
{\mten ``Analysis complete. Creature: Canterlot feral ghoul. Threat level: lethal. Tactical retreat is advised.''}
...
{\mten ``Negative. Scanning shows no activity in the area.''}
...
{\mten ``Running diagnostic procedure. Please wait. Negative. The subject is not ill, wounded, or poisoned.'' }
...
{\mten ``Diagnosis complete: the subject is deceased.''}

``Diseased? You just told me I was all right!''

{\mten ``Negative. I said that you were not ill.''}

She frowned. ``Waaaait just a moment. I'm not ill, but I'm diseased?''

{\mten ``Negative. You are deceased.''}

``But that's what I just said!'' She stomped her hoof.

{\mten ``Negative. The word you are using is incorr-''}
...
{\mten ``Affirmative. The nearest likely-intact MoM hub is located in this direction. However, it is not currently broadcasting. Other hubs are also located further down this route.''}
...
{\mten ``Warning. Several hostiles detected. Caution is advised.''}
...
{\mten ``Warning. Breach in containment layer. Exposure to external elements unavoidable. Survival of subject not guaranteed. Self repairing magic activated.'' }
...
{\mten ``Warning. Pink agent, Littlehorn Type detected.''}
...
{\mten ``Warning. Breach in the containment layer. Exposure to external elements unavoidable. Survival of the subject is not guaranteed. Repairs in progress.''}
...
{\mten ``Repairs completed. Containment restored. Running medical diagnostic. Subject deceased.''}

``Don't you dare start that again! We're in a pinch here!''

{\mten ``Negative. No immediate threats detected. Hostile count in the area: zero.''}

``Count? Mister Horse Tile is a noble pony?''

{\mten ``Negative. The correct word is hostile. You are distorting the meaning of-''}
...
{\mten ``Affirmative. All systems are powered and ready.''}

``Ah\dots right\dots I\dots I just wanted to say that I'm sorry\dots I didn't mean to shout at you. I\dots''

{\mten ``Warning. This program is not designed for socializing. The emergency mode only provides hardware support, voice command interpretation, and basic survival advice.''}

``I\dots please\dots please, please, please, don't leave me alone! I'm sorry! Please take me to my mom!''

{\mten ``Location MoM already set as priority navigation point.''}
...
{\mten ``Affirmative. It is the set priority.''}
...
{\mten ``Affirmative. I receive several radio signals. Some of them are meant for entertainment.''}
